...
//     version 1.14.0
//     from Assets/Characters/_Player/Input/Input MasterBackup.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Characters/_Player/Input/Input MasterBackup.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @InputMasterBackup: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    /// </summary>
    public @InputMasterBackup()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""Input MasterBackup"",
    ""maps"": [
        {
            ""name"": ""Typhis"",
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""b59e9dc9-469f-4645-9d4e-d2ce9f184f93"",
                ...
                {
                    ""name"": """",
                    ""id"": ""9e2c3b4f-b91d-4ab9-a295-dfb866c21848"",
                ...
                {
                    ""name"": """",
                    ""id"": ""1c6c1254-6dd3-4c92-a6f4-a78c35705b60"",
    ...
    ~@InputMasterBackup()
    {
        UnityEngine.Debug.Assert(!m_Typhis.enabled, "This will cause a leak and performance issues, InputMasterBackup.Typhis.Disable() has not been called.");
    }
    ...
    public struct TyphisActions
    {
        ...
        /// </summary>
        public TyphisActions(@InputMasterBackup wrapper) { m_Wrapper = wrapper; }
        /// <summary>
