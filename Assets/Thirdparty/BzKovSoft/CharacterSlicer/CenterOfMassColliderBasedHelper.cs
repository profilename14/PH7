...
{
	/// <summary>
	/// Sliceable character component manager helper class
	/// </summary>
	public static class CenterOfMassColliderBasedHelper
	{
		public static bool CalculateCenter(Rigidbody rigidbody, Collider[] possibleColliders, Rigidbody[] possibleRigids)
		{
		...
		private static List<Collider> GetColliders(Transform transform, Collider[] possibleColliders, Rigidbody[] possibleRigids)
		{
		...
		private static void GetCollidersRec(Transform transform, List<Collider> colliders, Collider[] possibleColliders, Rigidbody[] possibleRigids)
		{
