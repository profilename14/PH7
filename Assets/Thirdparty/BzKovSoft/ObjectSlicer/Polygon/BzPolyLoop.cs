...
namespace BzKovSoft.ObjectSlicer.Polygon
{
	...
	public class BzPolyLoop
	{
		...
		/// <summary>
		/// Checks whether currenct policy is inside anotehr poly.
		/// </summary>
		...
		{
			// TODO: replace with simpler implementation
			var m = new Matrix4x4()
			{
		...
		/// <summary>
		/// Transform vertices from modal space to plane space and convert them to Vector2[]
		/// </summary>
		private Vector2[] ConvertV3ToV2(IBzSliceAdapter adapter, Vector3 normal)
		{
			...
			{
				Vector3 v3 = adapter.GetFixedPos(meshData, edge.value);
				v3 = rotation * v3;
				v2s[i] = v3;
